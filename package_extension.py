...
MANIFEST = {
    ...
    "name": "ppk2-power-profiler",
    "display_name": "PPK2 Power Profiler",
    "version": "1.0.0",
    ...
    "long_description": """The PPK2 Power Profiler MCP server allows AI assistants to:
...
Perfect for embedded development, IoT device optimization, and battery life analysis.""",
    ...
    "tools": [
        ...
        {"name": "measure", "description": "Capture power measurements for a duration and return statistics (min/max/avg)"},
        {"name": "measure_raw", "description": "Capture measurements and return raw sample data for visualization (max 1s)"},
        {"name": "measure_to_file", "description": "Capture measurements and save raw samples to a CSV file (max 60s)"},
        {"name": "start_streaming", "description": "Start streaming measurements to a TCP socket for real-time visualization"},
